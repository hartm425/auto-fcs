...
load("/Volumes/Beta/data/flow/testOPh/2016-07-27_PANEL 1_ZF_Group one_F1631305_002.fcs_panel1_pg.Rdata")
...
ggplot(data_xk_all , aes(x = tsne_1,y=tsne_2,color=as.factor(PhenoGraph))) +geom_point(size = .15)+ guides(colour = guide_legend(override.aes = list(size=4)))
