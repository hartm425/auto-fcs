...
panle1map = read.delim("/Users/Kitty/git/auto-fcs/explore/openCyto/autoManMap2.txt",stringsAsFactors = FALSE,sep = "\t") 
...
combineWSP <- function(outputDir, gateDir,inputFCSDir,panle1map) {
  ...
  outWsp1 = paste(outputDir, "panel1_ssssfull.wsp", sep = "")
 ...
 combineWSP(outputDir =outputDir,gateDir = gateDir,inputFCSDir = inputFCSDir,panle1map = panle1map)
