...
gh <- gs[[1]]
plot(gh)
plotGate(gs[[1]],scales=list(cex=c(1.2,1.2)),par.strip.text=list(cex=1.4),xlab=list(fontsize=2),ylab=list(fontsize=2),par.settings=list(gate.text=list(cex=1)),path=2)
