...
fcsFilesAll = unique(c(fcsFilesAllProbs, qcOutliers))[1]
...
compFrame <-
  function(frame,
    ...
    autoCounts =getStats(gs1 = gs1,qcVersion = qcVersion,metric = "count")
    autoProps =getStats(gs1 = gs1,qcVersion = qcVersion,metric = "freq")
    autos = rbind(autoCounts,autoProps)
    print(autos)
