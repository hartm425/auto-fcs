...
inputFCSDir = "/Volumes/Beta/data/flow/fcsNewMachine/"
...
compFrame <-
  function(frame,
    ...
    gateDef = data.frame(
      ...
      CD3Plus = getIndiceMat(gs1, "Tcell"),
      cd4Pcd8M = getIndiceMat(gs1, "CD4"),
      cd4Mcd8P = getIndiceMat(gs1, "CD8"),
      HLADR = getIndiceMat(gs1, "ActivatedCD4"),
      CCR7PCD45RAP = getIndiceMat(gs1, "CD4/CCR7+CD45RA+"),
      CCR7PCD45RAM = getIndiceMat(gs1, "CD4/CCR7+CD45RA-"),
      CCR7MCD45RAM = getIndiceMat(gs1, "CD4/CCR7-CD45RA-"),
      CCR7MCD45RAP = getIndiceMat(gs1, "CD4/CCR7-CD45RA+"),
