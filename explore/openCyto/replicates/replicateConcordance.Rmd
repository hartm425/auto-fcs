...
mets =   read.delim("/Volumes/Beta/data/flow/concordance/results_r6/all.metrics.txt",stringsAsFactors = FALSE,sep = "\t") 
save(mets,file ="/Volumes/Beta/data/flow/concordance/results_r6/all.metrics.Rdata" )
...
load("/Volumes/Beta/data/flow/concordance/results_r6/all.metrics.Rdata")
```
