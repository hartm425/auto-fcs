...
metsControls$CTRL_NAME =paste(metsControls$CTRL_NAME ,metsControls$Panel,sep="_" )
metsControls$Population =gsub("FITC-A+BV711-A-","BB515-A+BV 711-A-",metsControls$Population,fixed = TRUE)
metsControls$Population =gsub("FITC-A-BV711-A-","BB515-A-BV 711-A-",metsControls$Population,fixed = TRUE)
metsControls$Freq_Base=NA
metsControls$Freq_Base[metsControls$Panel=="panel1"] =metsControls$Freq_Base[metsControls$Panel=="panel1"]
...
p <- ggplot(df, aes(x=POP, y=CV_FREQ_BASE))
p + geom_boxplot() +theme(axis.text.x=element_text(angle=90,hjust=1)) +ylab("CV of Group (freq of lymph/pbmc)")+xlab("population")
